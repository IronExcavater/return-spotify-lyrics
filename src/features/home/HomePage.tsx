        ...
        <section className="mx-auto flex max-w-2xl flex-col gap-6 p-5">
            <div>
                ...
                <p className="mt-1 text-sm text-text-muted">
                    Shared app running in the {surface} surface.
                </p>
            </div>
            ...
            <Button
                ...
                onClick={() => setActiveBar('playback')}
            >
                Show player bar
            </Button>

            <label className="flex max-w-xs flex-col gap-2 text-sm text-text-muted">
                Example slider
                <Slider label="Example volume" defaultValue={65} />
            </label>
        </section>
    );
}
