...
export function PlaybackBar({
    ...
    const premiumTooltip = premiumRequired
    ...
    const navigateToRoute = (route: MediaRouteState) => {
        if (onOpenMediaRoute) {
    ...
    const handleOpenArtist = (artist: SimplifiedArtist | SimplifiedShow) => {
        ...
        if ('publisher' in artist) {
            navigateToRoute({ kind: 'show', id: artist.id });
            return;
        }
                    ...
                    <Flex direction="row" align="center" gap="2" flexGrow="1">
                        ...
                        >
                            ...
                            <Flex align="center" gap="1">
                                ...
                                {/* Previous button */}
                                <Tooltip
                                    content={premiumTooltip ?? 'Previous track'}
                                    className="shadow-lg"
                                >
                                    <IconButton
                                        variant="ghost"
                                ...
                                {/* Next button */}
                                <Tooltip
                                    content={premiumTooltip ?? 'Next track'}
                                    className="shadow-lg"
                                >
                                    <IconButton
                                        variant="ghost"
                ...
                {expanded && (
                    <Flex direction="column" gap="1">
                        ...
                        <Flex align="center" justify="end" gap="1">
                            ...
                            <Tooltip
                                content={premiumTooltip ?? 'Shuffle'}
                                className="shadow-lg"
                            >
                                <IconToggle
                                    variant="ghost"
