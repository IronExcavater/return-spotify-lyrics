                        ...
                        {mode !== 'v-list' && (
                            <StepperControl
                                ...
                                onValueChange={(val) =>
                                    changeCount(
                                        val,
                                        (value) => clampCount(value, colLimits),
                                        setColsDraft,
                                        'columns'
                                    )
                                }
                    ...
                    <>
                        ...
                        >
                            <StepperControl
                                ...
                                onValueFocus={() =>
                                    focusDraft(displayWidthStr, setWidthDraft)
                                }
                                suffix={
                                    <Text
                                        size="1"
                ...
                {mode === 'card' && (
                    <>
                        ...
                        >
                            <StepperControl
                                label="Size"
                                value={cardSizeDraft ?? displayCardSizeStr}
                                placeholder="2"
                                onDecrement={() => {
                                    setCardSizeDraft(null);
                                    const next = Math.max(1, cardSize - 1) as
                                        | 1
                                        | 2
                                        | 3;
                                    onChange(section.id, {
                                ...
                                onIncrement={() => {
                                    setCardSizeDraft(null);
                                    const next = Math.min(3, cardSize + 1) as
                                        | 1
                                        | 2
                                        | 3;
                                    onChange(section.id, {
                                ...
                                onValueBlur={() => blurCardSize(cardSizeDraft)}
                                onValueFocus={() =>
                                    focusDraft(
                                        displayCardSizeStr,
                                        setCardSizeDraft
