...
export function MediaView() {
    ...
    const headerPlayable = Boolean(header?.contextUri || header?.uri);
    const headerRadius = header?.imageShape === 'round' ? 'full' : 'small';
                        ...
                        <Flex gap="2" align="center">
                            <AvatarButton
                                avatar={{
                                    ...
                                    fallback:
                                        header.icon ??
                                        (type ? TYPE_ICONS[type] : null),
                                    radius: headerRadius,
                                    size: '6',
                                }}
                                aria-label={header.title}
                                disabled={!headerPlayable}
                                onClick={(event) => {
                                ...
                                className="group p-0"
                            >
                                {headerPlayable && header.imageUrl && (
